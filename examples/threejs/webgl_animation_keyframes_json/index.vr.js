  ...
  render() {
    return (
      <View>
        ...
        <AmbientLight style={{color:'#404040',transform: [{translate: this.state.cameraPosition}],}}/>
        <PointLight intensity={1} style={{color:'#ffffff',transform: [{translate: this.state.cameraPosition}],}}/>
